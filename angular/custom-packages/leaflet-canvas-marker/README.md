...
Create the wanted package and the relative package.json and webpack.config.js
after that go to the package folder and install the local packages with 
...
After the creation of a custom package you have to do the following on the project root in order to import in the project

    yarn add file:./src/main/custom-packages/...
    yarn install
