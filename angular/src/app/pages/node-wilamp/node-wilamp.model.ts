...
export class NodeWilamp implements EntityWithIcon, BaseEntity {
    private kBuf = new ArrayBuffer(8);
    private kBufAsF64 = new Float64Array(this.kBuf);
    private kBufAsI32 = new Int32Array(this.kBuf);
    ...
    constructor(
        ...
        public mac?: string,
        public logTimeIst?: number,
        public logTime0?: number,
        public logTime1?: number,
        public logTime2?: number,
        public logTime3?: number,
    ...
    getIconObject(mapIconOptions: {} | undefined): IconObject {
        ...
        if (mapIconOptions.hasOwnProperty('groupBy')) {
            switch (mapIconOptions['groupBy']) {
                case 'gateway':
                    color = this.decimalColorToHTMLcolor(this.gatewayId);
                    filtersActive = true;
                    break;
                case 'light_profile':
                    color = this.decimalColorToHTMLcolor(this.lightProfileId);
                    filtersActive = true;
                    break;
                case 'light_zone':
        ...
        switch (this.nodeType) {
            case 10:
                ...
                resultIcon.iconUrl = 'data:image/svg+xml;utf-8, \
