...
function formatSlider(name, value) {
...
function LQItodBm(lqi) {
    try {
        var val =  Math.round( ((7 * lqi -1970) / 20)* 10) / 10;
...
Date.prototype.getMinutesToDate = function(targetDate)
{
    return Math.floor(((targetDate - this)/1000)/60);
};

function DateStringFromUnixTimestamp(UNIX_timestamp){
