            ...
            !function () {
                ...
                if (0 != $("#m_chart_profit_share").length) {
                    var e = new Chartist.Pie("#m_chart_profit_share", {
                        ...
                        }, {value: 32, className: "custom", meta: {color: mUtil.getColor("accent")}}, {
                            value: 36,
                            className: "custom",
                ...
                if (0 !== $("#m_calendar").length) {
                    ...
                    e.format("YYYY-MM"), e.clone().subtract(1, "day").format("YYYY-MM-DD"), e.format("YYYY-MM-DD"), e.clone().add(1, "day").format("YYYY-MM-DD"), $("#m_calendar").fullCalendar({
                        ...
                        events: [{
                            ...
                            description: "Lorem ipsum conse ctetur adipi s cing"
                        }, {
