...
def api_root(request, format=None):
    ...
    url_dict['address_list'] = reverse(
        'wicloud:api:backend:address_list', request=request, format=format
    )
    url_dict['address_create'] = reverse(
        'wicloud:api:backend:address_create', request=request, format=format
    )
    url_dict['customer_list'] = reverse(
        'wicloud:api:backend:customer_list', request=request, format=format
    )
    url_dict['customer_create'] = reverse(
        'wicloud:api:backend:customer_create', request=request, format=format
    )
    url_dict['energy_interval_list'] = reverse(
        'wicloud:api:backend:energy_interval_list', request=request, format=format
    )
    url_dict['energy_interval_create'] = reverse(
        'wicloud:api:backend:energy_interval_create', request=request, format=format
    )
    url_dict['energy_meter_module_list'] = reverse(
        'wicloud:api:backend:energy_meter_module_list', request=request, format=format
    )
    url_dict['energy_meter_module_create'] = reverse(
        'wicloud:api:backend:energy_meter_module_create', request=request, format=format
    )
    url_dict['energy_meter_peak_measure_list'] = reverse(
        'wicloud:api:backend:energy_meter_peak_measure_list', request=request, format=format
    )
    url_dict['energy_meter_peak_measure_create'] = reverse(
        'wicloud:api:backend:energy_meter_peak_measure_create', request=request, format=format
    )
    url_dict['error_light_level_and_adc_mismatch_list'] = reverse(
        'wicloud:api:backend:error_light_level_and_adc_mismatch_list', request=request, format=format
    )
    url_dict['error_light_level_and_adc_mismatch_create'] = reverse(
        'wicloud:api:backend:error_light_level_and_adc_mismatch_create', request=request, format=format
    )
    url_dict['error_light_level_and_power_mismatch_list'] = reverse(
        'wicloud:api:backend:error_light_level_and_power_mismatch_list', request=request, format=format
    )
    url_dict['error_light_level_and_power_mismatch_create'] = reverse(
        'wicloud:api:backend:error_light_level_and_power_mismatch_create', request=request, format=format
    )
    url_dict['error_node_offline_list'] = reverse(
        'wicloud:api:backend:error_node_offline_list', request=request, format=format
    )
    url_dict['error_node_offline_create'] = reverse(
        'wicloud:api:backend:error_node_offline_create', request=request, format=format
    )
    url_dict['gateway_list'] = reverse(
        'wicloud:api:backend:gateway_list', request=request, format=format
    )
    url_dict['gateway_create'] = reverse(
        'wicloud:api:backend:gateway_create', request=request, format=format
    )
    url_dict['ime_power_counter_list'] = reverse(
        'wicloud:api:backend:ime_power_counter_list', request=request, format=format
    )
    url_dict['ime_power_counter_create'] = reverse(
        'wicloud:api:backend:ime_power_counter_create', request=request, format=format
    )
    url_dict['ime_power_measure_list'] = reverse(
        'wicloud:api:backend:ime_power_measure_list', request=request, format=format
    )
    url_dict['ime_power_measure_create'] = reverse(
        'wicloud:api:backend:ime_power_measure_create', request=request, format=format
    )
    url_dict['installation_list'] = reverse(
        'wicloud:api:backend:installation_list', request=request, format=format
    )
    url_dict['installation_create'] = reverse(
        'wicloud:api:backend:installation_create', request=request, format=format
    )
    url_dict['light_management_measure_list'] = reverse(
        'wicloud:api:backend:light_management_measure_list', request=request, format=format
    )
    url_dict['light_management_measure_create'] = reverse(
        'wicloud:api:backend:light_management_measure_create', request=request, format=format
    )
    url_dict['light_management_module_list'] = reverse(
        'wicloud:api:backend:light_management_module_list', request=request, format=format
    )
    url_dict['light_management_module_create'] = reverse(
        'wicloud:api:backend:light_management_module_create', request=request, format=format
    )
    url_dict['light_profile_list'] = reverse(
        'wicloud:api:backend:light_profile_list', request=request, format=format
    )
    url_dict['light_profile_create'] = reverse(
        'wicloud:api:backend:light_profile_create', request=request, format=format
    )
    url_dict['light_profile_slot_list'] = reverse(
        'wicloud:api:backend:light_profile_slot_list', request=request, format=format
    )
    url_dict['light_profile_slot_create'] = reverse(
        'wicloud:api:backend:light_profile_slot_create', request=request, format=format
    )
    url_dict['motion_event_list'] = reverse(
        'wicloud:api:backend:motion_event_list', request=request, format=format
    )
    url_dict['motion_event_create'] = reverse(
        'wicloud:api:backend:motion_event_create', request=request, format=format
    )
    url_dict['node_list'] = reverse(
        'wicloud:api:backend:node_list', request=request, format=format
    )
    url_dict['node_create'] = reverse(
        'wicloud:api:backend:node_create', request=request, format=format
    )
    url_dict['node_module_list'] = reverse(
        'wicloud:api:backend:node_module_list', request=request, format=format
    )
    url_dict['node_module_create'] = reverse(
        'wicloud:api:backend:node_module_create', request=request, format=format
    )
    url_dict['wilamp_alert_list'] = reverse(
        'wicloud:api:backend:wilamp_alert_list', request=request, format=format
    )
    url_dict['wilamp_alert_create'] = reverse(
        'wicloud:api:backend:wilamp_alert_create', request=request, format=format
    )
    url_dict['feeder_pillar_list'] = reverse(
        'wicloud:api:backend:feeder_pillar_list', request=request, format=format
    )
    url_dict['feeder_pillar_create'] = reverse(
        'wicloud:api:backend:feeder_pillar_create', request=request, format=format
    )
    url_dict['twilight_management_module_list'] = reverse(
        'wicloud:api:backend:twilight_management_module_list', request=request, format=format
    )
    url_dict['twilight_management_module_create'] = reverse(
        'wicloud:api:backend:twilight_management_module_create', request=request, format=format
    )
    url_dict['twilight_measure_list'] = reverse(
        'wicloud:api:backend:twilight_measure_list', request=request, format=format
    )
    url_dict['twilight_measure_create'] = reverse(
        'wicloud:api:backend:twilight_measure_create', request=request, format=format
    )
    url_dict['motion_management_module_list'] = reverse(
        'wicloud:api:backend:motion_management_module_list', request=request, format=format
    )
    url_dict['motion_management_module_create'] = reverse(
        'wicloud:api:backend:motion_management_module_create', request=request, format=format
    )
